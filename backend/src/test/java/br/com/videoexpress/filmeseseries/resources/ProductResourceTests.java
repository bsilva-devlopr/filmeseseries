...
import br.com.videoexpress.filmeseseries.controllers.products.ProductController;
...
public class ProductResourceTests {
    ...
    void setUp() {
        ...
        when(productService.findById(nonExistingId)).thenThrow(NotFoundException.class);

        when(productService.update(eq(existingId), any())).thenReturn(productDTO);
        when(productService.update(eq(nonExistingId), any())).thenThrow(NotFoundException.class);
